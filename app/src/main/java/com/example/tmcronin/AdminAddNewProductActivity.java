...
//code from youtube tutorial https://www.youtube.com/watch?v=emDhMx_2-1E&list=PLxefhmF0pcPlqmH_VfWneUjfuqhreUz-O&index=13
...
//key to getting the values in category
...
//info needed to be held
    ...
    private void ValidateProductData()
    {
        ...
        else if (TextUtils.isEmpty(Pname))
        {
            ...
            //display the time of the product to the new user
